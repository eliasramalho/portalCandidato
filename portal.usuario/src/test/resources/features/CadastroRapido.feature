...
@positivo @smoke
Cenario: CT01-Realizar o cadastro rapido
...
@negativo @teste 
Cenario: CT02-Realizar cadastro com campos em branco
Quando nao preencher os campos 
Entao o sistema retorna a mensagem de erro
		
@negativo		
Cenario: CT03-Preencher campo email com dados invalidos
Quando preencher o campo email
E os dados forem invalidos
Entao o sistema retorna uma mensagem

@positivo
Cenario: CT04-Preencher campos data nascimento com dados invalidos
...
@negativo 
Cenario: CT07-Modal de validacao com campos em branco
...
@negativo 
Cenario: CT14-Preencher formulario e nao aceitar os termos e condicoes de uso
